...
**Tests**: Testing tasks are post-content and OPTIONAL. Include them only when explicitly requested in the feature specification.
...
- [ ] T004 [P] Audit dependency list and remove unnecessary packages
...
- [ ] T011 Define responsive layout baseline and light-theme UI tokens
...
### Post-Content Validation for User Story 1 (OPTIONAL)

> **NOTE: Add validation/testing only after content and core implementation tasks are complete.**
...
### Post-Content Validation for User Story 2 (OPTIONAL)
...
### Post-Content Validation for User Story 3 (OPTIONAL)
...
- [ ] TXXX [P] Post-content test execution (if requested) in tests/unit/
...
- Optional validation/testing after content completion
...
- All optional post-content validation tasks for a story marked [P] can run in parallel
...
```bash
# Launch post-content validation for User Story 1 together (if requested):
...
- Testing is post-content and optional unless explicitly required by the feature request
